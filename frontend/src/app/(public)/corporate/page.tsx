...
import { Building, Users, TrendingUp, Award, CheckCircle, ChevronRight, Mail, Phone, Calendar } from "lucide-react"
...
export default function CorporateProgramsPage() {
  ...
  const programs: Program[] = cmsContent?.programs?.types || defaultPrograms
