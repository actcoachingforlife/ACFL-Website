        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.p
              ...
              className="text-sm md:text-base text-white/80 uppercase tracking-wider mb-6"
            >
              Transform
            </motion.p>
            <motion.h1
            ...
            >
              Unlock collective potential through evidence-based ACT coaching designed to help teams and individuals breakthrough personal and professional barriers
            </motion.p>
            ...
            >
              <a href="/blog">
                <button className="bg-white hover:bg-gray-100 text-gray-900 font-semibold px-8 py-3 rounded-lg transition-all shadow-lg hover:shadow-xl min-w-[140px]">
                  Explore
                </button>
              </a>
              <a href="/assessment">
                <button className="bg-transparent hover:bg-white/10 text-white font-semibold px-8 py-3 rounded-lg border-2 border-white transition-all min-w-[140px]">
                  Assessment
                </button>
              </a>
            </motion.div>
