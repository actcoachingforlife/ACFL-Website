...
export default function AdminSettings() {
  ...
  return (
    <div className="w-full">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 animate-in fade-in slide-in-from-bottom-2 duration-300">
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-700 dark:to-gray-750 border-b border-gray-200 dark:border-gray-600 rounded-t-xl sm:rounded-t-2xl">
            <nav className="flex overflow-x-auto scrollbar-hide px-3 sm:px-6" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
              {tabs.map((tab, index) => (
                ...
                >
                  <tab.icon className={`h-4 w-4 sm:h-5 sm:w-5 flex-shrink-0 transition-transform duration-200 ${
                    activeTab === tab.id ? 'scale-110' : 'group-hover:scale-110'
                  }`} />
                  <span className="hidden xs:inline">{tab.label}</span>
                  {activeTab === tab.id && (
                    <div className="absolute inset-0 bg-gradient-to-r from-blue-400 to-indigo-400 opacity-10 rounded-t-lg pointer-events-none"></div>
                  )}
                </button>
              ))}
            </nav>
                    ...
                    <div className="flex-shrink-0">
                      <label className="inline-flex items-center cursor-pointer group">
                        ...
                        <div className={`relative w-11 h-6 rounded-full transition-all duration-200 ease-in-out shadow-inner ${
                          settings.general.maintenanceMode ? 'bg-blue-600 shadow-blue-200 dark:shadow-blue-900' : 'bg-gray-200 dark:bg-gray-700'
                        }`}>
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between space-y-3 sm:space-y-0">
                    ...
                    <div className="flex-shrink-0">
                      <label className="inline-flex items-center cursor-pointer group">
                        ...
                        />
                        <div className={`relative w-11 h-6 rounded-full transition-all duration-200 ease-in-out shadow-inner ${
                          settings.general.registrationEnabled ? 'bg-blue-600 shadow-blue-200 dark:shadow-blue-900' : 'bg-gray-200 dark:bg-gray-700'
                        }`}>
                          <div className={`absolute top-0.5 left-0.5 bg-white w-5 h-5 rounded-full transition-all duration-200 ease-in-out shadow-md ${
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between space-y-3 sm:space-y-0">
                    ...
                    <div className="flex-shrink-0">
                      <label className="inline-flex items-center cursor-pointer group">
                        ...
                        />
                        <div className={`relative w-11 h-6 rounded-full transition-all duration-200 ease-in-out shadow-inner ${
                          settings.general.coachApprovalRequired ? 'bg-blue-600 shadow-blue-200 dark:shadow-blue-900' : 'bg-gray-200 dark:bg-gray-700'
                        }`}>
                          <div className={`absolute top-0.5 left-0.5 bg-white w-5 h-5 rounded-full transition-all duration-200 ease-in-out shadow-md ${
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between space-y-3 sm:space-y-0">
                      ...
                      <div className="flex-shrink-0">
                        <label className="inline-flex items-center cursor-pointer group">
                          ...
                          />
                          <div className={`relative w-11 h-6 rounded-full transition-all duration-200 ease-in-out shadow-inner ${
                            settings.notifications.emailNotifications ? 'bg-blue-600 shadow-blue-200 dark:shadow-blue-900' : 'bg-gray-200 dark:bg-gray-700'
                          }`}>
                            <div className={`absolute top-0.5 left-0.5 bg-white w-5 h-5 rounded-full transition-all duration-200 ease-in-out shadow-md ${
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between space-y-3 sm:space-y-0">
                      ...
                      <div className="flex-shrink-0">
                        <label className="inline-flex items-center cursor-pointer group">
                          ...
                          />
                          <div className={`relative w-11 h-6 rounded-full transition-all duration-200 ease-in-out shadow-inner ${
                            settings.notifications.adminAlerts ? 'bg-blue-600 shadow-blue-200 dark:shadow-blue-900' : 'bg-gray-200 dark:bg-gray-700'
                          }`}>
                            <div className={`absolute top-0.5 left-0.5 bg-white w-5 h-5 rounded-full transition-all duration-200 ease-in-out shadow-md ${
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between space-y-3 sm:space-y-0">
                      ...
                      <div className="flex-shrink-0">
                        <label className="inline-flex items-center cursor-pointer group">
                          ...
                          />
                          <div className={`relative w-11 h-6 rounded-full transition-all duration-200 ease-in-out shadow-inner ${
                            settings.notifications.userWelcomeEmails ? 'bg-blue-600 shadow-blue-200 dark:shadow-blue-900' : 'bg-gray-200 dark:bg-gray-700'
                          }`}>
                            <div className={`absolute top-0.5 left-0.5 bg-white w-5 h-5 rounded-full transition-all duration-200 ease-in-out shadow-md ${
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between space-y-3 sm:space-y-0">
                    ...
                    <div className="flex-shrink-0">
                      <label className="inline-flex items-center cursor-pointer group">
                        ...
                        />
                        <div className={`relative w-11 h-6 rounded-full transition-all duration-200 ease-in-out shadow-inner ${
                          settings.security.requireTwoFactor ? 'bg-blue-600 shadow-blue-200 dark:shadow-blue-900' : 'bg-gray-200 dark:bg-gray-700'
                        }`}>
                          <div className={`absolute top-0.5 left-0.5 bg-white w-5 h-5 rounded-full transition-all duration-200 ease-in-out shadow-md ${
