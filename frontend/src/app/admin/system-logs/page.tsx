...
export default function SystemLogs() {
  ...
  // Check if user is admin-only - staff should not have access to system logs
        ...
        <div className="max-w-2xl w-full">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 md:p-12">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 text-center mb-6">
              The System Logs page is restricted to administrators only. Staff members do not have permission to access this area.
            </p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-blue-700 dark:text-blue-300">
                    System logs contain sensitive audit information including user actions, security events, and system changes.
                    Access to this information is restricted to system administrators to maintain security and data integrity.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
              <p className="text-sm text-gray-500 dark:text-gray-500 text-center">
                If you believe you need access to view system logs, please contact your system administrator.
              </p>
            </div>
          </div>
        </div>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden" data-tour="log-filters">
        {/* Gradient Header */}
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden" data-tour="audit-trail">
        {isLoading ? (
